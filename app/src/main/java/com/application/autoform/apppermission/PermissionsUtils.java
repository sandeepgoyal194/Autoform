...
final public class PermissionsUtils {
    ...
    public static void requestPermission(Fragment activity, String permission, int requestCode) {
    ...
    public static boolean handlePermissionRequestResult(Fragment activity, String[] permissions,
                                                        int[] grantResults) {
        ...
        if (!isGranted) {
            boolean shouldShowDeniedAlert = true;
            for (String permission : permissions) {
                shouldShowDeniedAlert = shouldShowDeniedAlert && !(ActivityCompat
                        .shouldShowRequestPermissionRationale(activity.getActivity(), permission));
                Log.d(TAG, "should alert : " + shouldShowDeniedAlert);
            }
            if (shouldShowDeniedAlert) {
                showPermissionAlert(activity.getActivity());
            }
        }
        return isGranted;
    }
